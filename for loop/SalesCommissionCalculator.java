//4 Monthly Sales Commission Calculator
...
//             if (sales <= 40000) rate = 5;
//             else if (sales <= 80000) rate = 8;
//             else if (sales <= 100000) rate = 10;
//             else if (sales <= 150000) rate = 12;
//             else rate = 15;

//             double commission = sales * rate / 100;
//             double bonus = 0;

//             if (sales >= 150000) bonus = 3000;
//             else if (sales >= 100000) bonus = 2000;
